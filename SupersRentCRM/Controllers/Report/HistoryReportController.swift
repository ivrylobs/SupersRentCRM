...
class HistoryReportController: UIViewController {
	...
	override func viewDidLoad() {
		...
		let historyReportURL = "https://api.supersrent.com/app-admin/api/orderDetailsReturn/\(userData["username"].stringValue)"
		
		self.pullAPI(url: historyReportURL, method: .get, header: header) { json in
			self.tableData = json
...
extension HistoryReportController: UITableViewDelegate {
	
	
}

extension HistoryReportController: UITableViewDataSource {
